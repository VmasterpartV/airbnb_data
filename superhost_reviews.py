# -*- coding: utf-8 -*-
"""
Created on Wed May 31 00:22:43 2023
...
df_listings = df_listings[['listing_id', 'host_is_superhost']]
...
df_avg_reviews = df_merged.groupby('host_is_superhost')['review_count'].mean().reset_index(name='average_reviews')

# Graficar el número promedio de reseñas por tipo de anfitrión
fig, ax = plt.subplots(figsize=(8, 6))

# Crear un gráfico de barras
ax.bar(df_avg_reviews['host_is_superhost'], df_avg_reviews['average_reviews'])

# Personalizar el gráfico
ax.set_xlabel('Superhost')
ax.set_ylabel('Número Promedio de Reseñas')
ax.set_title('Impacto del Superhost en las Reseñas')
